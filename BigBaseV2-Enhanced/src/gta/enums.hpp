...
{
	SKEL_ROOT = 0x0, // ¸ù¹Ç÷À
	SKEL_Pelvis = 0x2e28, // ¹ÇÅè
	SKEL_L_Thigh = 0xe39f, // ×ó´óÍÈ
	SKEL_L_Calf = 0xf9bb, // ×óÐ¡ÍÈ
	SKEL_L_Foot = 0x3779, // ×ó½Å
	SKEL_L_Toe0 = 0x83c, // ×ó½ÅÖº
	IK_L_Foot = 0xfedd, // ×ó½ÅIK
	PH_L_Foot = 0xe175, // ×ó½ÅÎïÀí¹Ç÷À
	MH_L_Knee = 0xb3fe, // ×óÏ¥¸Ç¸¨Öú¹Ç÷À
	SKEL_R_Thigh = 0xca72, // ÓÒ´óÍÈ
	SKEL_R_Calf = 0x9000, // ÓÒÐ¡ÍÈ
	SKEL_R_Foot = 0xCC4D, // ÓÒ½Å
	SKEL_R_Toe0 = 0x512d, // ÓÒ½ÅÖº
	IK_R_Foot = 0x8aae, // ÓÒ½ÅIK
	PH_R_Foot = 0x60e6, // ÓÒ½ÅÎïÀí¹Ç÷À
	MH_R_Knee = 0x3fcf, // ÓÒÏ¥¸Ç¸¨Öú¹Ç÷À
	RB_L_ThighRoll = 0x5c57, // ×ó´óÍÈ¹ö¶¯
	RB_R_ThighRoll = 0x192a, // ÓÒ´óÍÈ¹ö¶¯
	SKEL_Spine_Root = 0xe0fd, // ¼¹Öù¸ù²¿
	SKEL_Spine0 = 0x5c01, // ¼¹Öù0
	SKEL_Spine1 = 0x60f0, // ¼¹Öù1
	SKEL_Spine2 = 0x60f1, // ¼¹Öù2
	SKEL_Spine3 = 0x60f2, // ¼¹Öù3
	SKEL_L_Clavicle = 0xfcd9, // ×óËø¹Ç
	SKEL_L_UpperArm = 0xb1c5, // ×óÉÏ±Û
	SKEL_L_Forearm = 0xeeeb, // ×óÇ°±Û
	SKEL_L_Hand = 0x49d9, // ×óÊÖ
	SKEL_L_Finger00 = 0x67f2, // ×óÊÖÄ´Ö¸
	SKEL_L_Finger01 = 0xff9,
	SKEL_L_Finger02 = 0xffa,
	SKEL_L_Finger10 = 0x67f3, // ×óÊÖÊ³Ö¸
	SKEL_L_Finger11 = 0x1049,
	SKEL_L_Finger12 = 0x104a,
	SKEL_L_Finger20 = 0x67f4, // ×óÊÖÖÐÖ¸
	SKEL_L_Finger21 = 0x1059,
	SKEL_L_Finger22 = 0x105a,
	SKEL_L_Finger30 = 0x67f5, // ×óÊÖÎÞÃûÖ¸
	SKEL_L_Finger31 = 0x1029,
	SKEL_L_Finger32 = 0x102a,
	SKEL_L_Finger40 = 0x67f6, // ×óÊÖÐ¡Ö¸
	SKEL_L_Finger41 = 0x1039,
	SKEL_L_Finger42 = 0x103a,
	PH_L_Hand = 0xeb95, // ×óÊÖÎïÀí¹Ç÷À
	IK_L_Hand = 0x8cbd, // ×óÊÖIK
	RB_L_ForeArmRoll = 0xee4f, // ×óÇ°±Û¹ö¶¯
	RB_L_ArmRoll = 0x1470, // ×óÊÖ±Û¹ö¶¯
	MH_L_Elbow = 0x58b7, // ×óÖâ¸¨Öú¹Ç÷À
	SKEL_R_Clavicle = 0x29d2, // ÓÒËø¹Ç
	SKEL_R_UpperArm = 0x9d4d, // ÓÒÉÏ±Û
	SKEL_R_Forearm = 0x6e5c, // ÓÒÇ°±Û
	SKEL_R_Hand = 0xdead, // ÓÒÊÖ
	SKEL_R_Finger00 = 0xe5f2, // ÓÒÊÖÄ´Ö¸
	SKEL_R_Finger01 = 0xfa10,
	SKEL_R_Finger02 = 0xfa11,
	SKEL_R_Finger10 = 0xe5f3, // ÓÒÊÖÊ³Ö¸
	SKEL_R_Finger11 = 0xfa60,
	SKEL_R_Finger12 = 0xfa61,
	SKEL_R_Finger20 = 0xe5f4, // ÓÒÊÖÖÐÖ¸
	SKEL_R_Finger21 = 0xfa70,
	SKEL_R_Finger22 = 0xfa71,
	SKEL_R_Finger30 = 0xe5f5, // ÓÒÊÖÎÞÃûÖ¸
	SKEL_R_Finger31 = 0xfa40,
	SKEL_R_Finger32 = 0xfa41,
	SKEL_R_Finger40 = 0xe5f6, // ÓÒÊÖÐ¡Ö¸
	SKEL_R_Finger41 = 0xfa50,
	SKEL_R_Finger42 = 0xfa51,
	PH_R_Hand = 0x6f06, // ÓÒÊÖÎïÀí¹Ç÷À
	IK_R_Hand = 0x188e, // ÓÒÊÖIK
	RB_R_ForeArmRoll = 0xab22, // ÓÒÇ°±Û¹ö¶¯
	RB_R_ArmRoll = 0x90ff, // ÓÒÊÖ±Û¹ö¶¯
	MH_R_Elbow = 0xbb0, // ÓÒÖâ¸¨Öú¹Ç÷À
	SKEL_Neck_1 = 0x9995, // ¾±²¿
	SKEL_Head = 0x796e, // Í·²¿
	IK_Head = 0x322c, // Í·²¿IK
	FACIAL_facialRoot = 0xfe2c, // Ãæ²¿¸ù¹Ç÷À
	FB_L_Brow_Out_000 = 0xe3db, // ×óÃ¼Ã«Íâ²à
	FB_L_Lid_Upper_000 = 0xb2b6, // ×óÉÏÑÛíú
	FB_L_Eye_000 = 0x62ac, // ×óÑÛ
	FB_L_CheekBone_000 = 0x542e, // ×óÈ§¹Ç
	FB_L_Lip_Corner_000 = 0x74ac, // ×ó×ì½Ç
	FB_R_Lid_Upper_000 = 0xaa10, // ÓÒÉÏÑÛíú
	FB_R_Eye_000 = 0x6b52, // ÓÒÑÛ
	FB_R_CheekBone_000 = 0x4b88, // ÓÒÈ§¹Ç
	FB_R_Brow_Out_000 = 0x54c, // ÓÒÃ¼Ã«Íâ²à
	FB_R_Lip_Corner_000 = 0x2ba6, // ÓÒ×ì½Ç
	FB_Brow_Centre_000 = 0x9149, // Ã¼Ã«ÖÐÐÄ
	FB_UpperLipRoot_000 = 0x4ed2, // ÉÏ´½¸ù²¿
	FB_UpperLip_000 = 0xf18f, // ÉÏ´½
	FB_L_Lip_Top_000 = 0x4f37, // ×óÉÏ´½
	FB_R_Lip_Top_000 = 0x4537, // ÓÒÉÏ´½
	FB_Jaw_000 = 0xb4a0, // ÏÂ°Í
	FB_LowerLipRoot_000 = 0x4324, // ÏÂ´½¸ù²¿
	FB_LowerLip_000 = 0x508f, // ÏÂ´½
	FB_L_Lip_Bot_000 = 0xb93b, // ×óÏÂ´½
	FB_R_Lip_Bot_000 = 0xc33b, // ÓÒÏÂ´½
	FB_Tongue_000 = 0xb987, // ÉàÍ·
	RB_Neck_1 = 0x8b93, // ¾±²¿¹ö¶¯
	IK_Root = 0xdd1c // IK¸ù¹Ç÷À
};
